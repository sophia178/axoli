...
export const shopCatalog: ShopCatalogItem[] = [
  { id: id(0x01), name: 'Pellets', type: 'food', cost: 5, image_url: foodIcon('pellets'), is_premium: false, is_seasonal: false, meta: { happiness: 5 } },
  { id: id(0x02), name: 'Bloodworms', type: 'food', cost: 12, image_url: foodIcon('bloodworms'), is_premium: false, is_seasonal: false, meta: { happiness: 10 } },
  { id: id(0x03), name: 'Brine shrimp', type: 'food', cost: 15, image_url: foodIcon('brineShrimp'), is_premium: false, is_seasonal: false, meta: { happiness: 12 } },
  { id: id(0x04), name: 'Daphnia', type: 'food', cost: 18, image_url: foodIcon('daphnia'), is_premium: false, is_seasonal: false, meta: { happiness: 14 } },
  { id: id(0x05), name: 'Tubifex worms', type: 'food', cost: 22, image_url: foodIcon('tubifex'), is_premium: false, is_seasonal: false, meta: { happiness: 16 } },
  { id: id(0x06), name: 'Snail', type: 'food', cost: 28, image_url: foodIcon('snail'), is_premium: false, is_seasonal: false, meta: { happiness: 18 } },
  { id: id(0x07), name: 'Mini crab', type: 'food', cost: 32, image_url: foodIcon('miniCrab'), is_premium: false, is_seasonal: false, meta: { happiness: 20 } },
  { id: id(0x08), name: 'Water flea', type: 'food', cost: 10, image_url: foodIcon('daphnia'), is_premium: false, is_seasonal: false, meta: { happiness: 8 } },
  { id: id(0x09), name: 'Algae wafer', type: 'food', cost: 14, image_url: foodIcon('algaeWafer'), is_premium: false, is_seasonal: false, meta: { happiness: 10 } },
  { id: id(0x0a), name: 'Shrimp', type: 'food', cost: 26, image_url: foodIcon('brineShrimp'), is_premium: false, is_seasonal: false, meta: { happiness: 18 } },
  { id: id(0x0b), name: 'Tadpole', type: 'food', cost: 30, image_url: foodIcon('tadpole'), is_premium: false, is_seasonal: false, meta: { happiness: 20 } },
  { id: id(0x0c), name: 'Earthworm', type: 'food', cost: 34, image_url: foodIcon('tubifex'), is_premium: false, is_seasonal: false, meta: { happiness: 22 } },
  { id: id(0x0d), name: 'Feeder fish', type: 'food', cost: 38, image_url: foodIcon('feederFish'), is_premium: false, is_seasonal: false, meta: { happiness: 24 } },
  { id: id(0x0e), name: 'Mystery snack', type: 'food', cost: 45, image_url: foodIcon('mystery'), is_premium: false, is_seasonal: true, meta: { happiness: 30 } },
  { id: id(0x0f), name: 'Golden apple', type: 'food', cost: 60, image_url: foodIcon('goldenApple'), is_premium: false, is_seasonal: false, meta: { happiness: 40 } },
  { id: id(0x10), name: 'Birthday cake slice', type: 'food', cost: 80, image_url: foodIcon('cake'), is_premium: false, is_seasonal: true, meta: { happiness: 55 } },
  { id: id(0x41), name: 'Watermelon slice', type: 'food', cost: 22, image_url: foodIcon('watermelon'), is_premium: false, is_seasonal: true, meta: { happiness: 16 } },
  { id: id(0x42), name: 'Strawberry', type: 'food', cost: 18, image_url: foodIcon('strawberry'), is_premium: false, is_seasonal: true, meta: { happiness: 14 } },
  { id: id(0x43), name: 'Donut', type: 'food', cost: 40, image_url: foodIcon('donut'), is_premium: false, is_seasonal: true, meta: { happiness: 26 } },
  { id: id(0x44), name: 'Sushi roll', type: 'food', cost: 45, image_url: foodIcon('sushi'), is_premium: false, is_seasonal: false, meta: { happiness: 30 } },
